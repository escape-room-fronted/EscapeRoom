      ...
      {showModal ? (
        ...
        validate={(values)=> {
          ...
          if (!values.user_email){
            ...
            errors.user_email="El correo solo puede contener letras, puntos y _."
          }
          if (!values.user_name){
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className=" border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-gray outline-none focus:outline-none">
                ...
                <div className="mb-6">
                      ...
                      />
                      <ErrorMessage name="user_name" component={()=> (<div className="text-yellow text-sm" >{errors.user_name}</div>)} />
                    </div>
                    <div className="mb-6">
                      <label className="block mb-2 font-title text-sm text-white font-semibold">
                        Nombre Completo
                      ...
                      <Field
                        ...
                        className="font-title w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-red dark:bg-bglight dark:text-colorparagraph dark:placeholder-gray-500 dark:border-red dark:focus:ring-red dark:focus:border-red"
                      />
                      <ErrorMessage name="user_last_name" component={()=> (<div className="text-yellow text-sm">{errors.user_last_name}</div>)} />
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      />
                      <ErrorMessage name="user_email" component={()=> (<div className="text-yellow text-sm">{errors.user_email}</div>)} />
                    </div>
